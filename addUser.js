...
function writeUserData(Fname, Lname, Hobby, Food, Subject, userId) {
    ...
    console.log(Fname + ', ' + Lname + ', ' + Hobby + ', ' + Food + ', ' + Subject);
}
*/
...
function addUser(newid, email, password, hobby, food, subject, year, userInfo, uid) {
    ...
    {year:year},
    {email:email}]
    console.log(newid, email, password, hobby, food, subject, year);
        ...
        firebase.auth().signInWithEmailAndPassword(email, password)
            .then((name, year) => {
                ...
                yearRef.on('value', (snapshot) => {
                    year = snapshot.val();
                    console.log(email + ' has signed in. Email = ' + email + ', name = ' + name + ', year = ' + year);
                })
